# Code from Kyle Pearson to be used for aligning signal like,  spectra,
# profiles, etc
# GitHub Repository
...
def equalize_array_size(array1, array2):
    ...
    Returns:
        ...
        array2 (1d array/list): middle of the initial signal if there is a size
        difference between the array 1 and 2
